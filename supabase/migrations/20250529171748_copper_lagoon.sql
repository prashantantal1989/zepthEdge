/*
  ...
  1. New Tables
    - Documents, Transmittals, Submittals, RFIs, and Tasks tables
    - Each with appropriate metadata and user tracking
    - Foreign key relationships to properties and users
    - Status enums and constraints

  2. Security
    - RLS enabled on all tables
    - Policies for CRUD operations based on property access
    - Safe policy creation with existence checks

  3. Indexes
    - Property ID indexes for efficient joins
    - Status and category indexes for filtering
    - User-related indexes for assignments
*/
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE tablename = 'documents' AND policyname = 'Users can create documents'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'documents' AND policyname = 'Users can read documents for their properties'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'documents' AND policyname = 'Users can update their own documents'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'transmittals' AND policyname = 'Users can create transmittals'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'transmittals' AND policyname = 'Users can read transmittals for their properties'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'transmittals' AND policyname = 'Users can update their own transmittals'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'submittals' AND policyname = 'Users can create submittals'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'submittals' AND policyname = 'Users can read submittals for their properties'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'submittals' AND policyname = 'Users can update their own submittals'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'rfis' AND policyname = 'Users can create RFIs'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'rfis' AND policyname = 'Users can read RFIs for their properties'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'rfis' AND policyname = 'Users can update their own RFIs'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'tasks' AND policyname = 'Users can create tasks'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'tasks' AND policyname = 'Users can read tasks for their properties'
  ) THEN
