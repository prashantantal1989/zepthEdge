/*
  # Create workflows table and related functionality

  1. New Tables
    - `workflows`
      - `id` (uuid, primary key)
      - `template_id` (uuid, foreign key to workflow_templates.id)
      - `entity_type` (text, e.g., 'budget_request', 'capex_request', etc.)
      - `entity_id` (uuid, reference to the entity)
      - `status` (text, e.g., 'active', 'completed', 'rejected')
      - `current_step` (integer, default 0)
      - `steps_data` (jsonb, stores the workflow steps with their status)
  ...
  2. Security
    ...
    - Add policies for creating, reading, and updating workflow instances
*/
