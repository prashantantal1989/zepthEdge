/*
  # Add workflows table and policies
  
  1. Tables
    - `users` - Base table for user accounts
    - `workflows` - Tracks workflow instances and their states
    
  2. Changes
    - Create users table if it doesn't exist
    - Create workflows table with foreign key to users
    - Add indexes for efficient querying
    - Enable RLS and add policies for proper access control
    
  3. Security
    - Enable RLS on workflows table
    - Add policies for create, read, and update operations
    - Policies enforce property-based access control
*/
