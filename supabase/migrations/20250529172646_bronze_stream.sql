/*
  ...
  1. New Tables
    - `documents` - Centralized repository for all non-financial files
    - `transmittals` - Send and track document transmissions
    - `submittals` - Non-financial approval workflow
