/*
  # Fix Workflow Table and Policies

  1. New Tables
    - None (fixes existing workflows table)
  
  2. Changes
    - Updates foreign key references to use auth.users instead of users
    - Drops existing policies before recreating them to avoid conflicts
    - Adds proper RLS policies for workflow management
  
  3. Security
    - Maintains RLS on workflows table
